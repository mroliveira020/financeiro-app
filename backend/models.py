...
def listar_prospeccoes_capturados(
    ...
    for row in rows:
        ...
        tem_analise = row.get("analise_numero_bem") is not None
        analise_inputs = {
            ...
            "valor_maximo_lance": float(row["valor_maximo_lance"]) if row["valor_maximo_lance"] is not None else valor_minimo,
        ...
        result.append({
            ...
            "capital_investido_estimado": calculos_analise["capital_investido_estimado"] if calculos_analise else None,
        })
...
def calcular_analise_prospeccao(dados):
    ...
    return {
        ...
        "despesa_mensal_operacional": despesa_mensal_operacional,
        ...
        "despesas_pos_venda": _round_money(comissao_corretor_valor + ganho_capital_valor),
