...
2.6 [x] Gráfico financeiro
   ...
   2.15 [ ] Prospecções / Supabase
       ...
       2.15.5 [ ] UX Prospecções: filtros completos (UF, modalidade, status), mais colunas (descrição), ajuste de tipografia e label/ícone, controle de linhas exibidas e ação “Incluir em selecionados” direto da tabela.
