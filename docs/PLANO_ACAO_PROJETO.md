...
2. [ ] **Preparar a camada de avaliação detalhada com IA**
   ...
   2.2. [x] Expor no backend o campo `analise_ia_salva` na listagem de selecionados.
   2.3. [x] Criar endpoints Render para leitura, escrita e chat da análise IA, com fila em `ia_jobs`.
